...
meta:
	ADDON_NAME = ofxPointClusters
	ADDON_DESCRIPTION = Manage a set of clusters based on an incoming stream of points
	ADDON_AUTHOR = @smeyfroi
	ADDON_TAGS = "addon"
	ADDON_URL = http://github.com/smeyfroi/ofxPointClusters
